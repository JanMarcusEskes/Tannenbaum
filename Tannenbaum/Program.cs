...
namespace Tannenbaum
{
  class Program
  {
    static void Main(string[] args)
    {
      ...
      {
        case "E": größe = 3; preis = 7; Modell = "Einsteiger"; break;
        case "O": größe = 5; preis = 10; zusatz = true; Modell = "Optimist"; break;
        case "F": größe = 8; preis = 15; zusatz = true; Modell = "Familie"; break;
        case "B": größe = 12; preis = 20; zusatz = true; Modell = "Business"; break;
        case "D": größe = 12; preis = 25; material = 'A'; kerzen = 1; Modell = "Deluxe"; break;
        case "U": größe = 30; preis = 100; zusatz = true; Modell = "Ultimate"; break;
        case "X": Console.WriteLine("Das Program wird geschlossen"); Console.ReadLine(); return;
        default: Console.WriteLine("Es wurde ein ungültiger Menüpunkt gewählt!"); Console.ReadLine(); return;
      }
